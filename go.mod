module github.com/jchavannes/mls
...
require (
	...
	github.com/cisco/go-hpke v0.0.0-20200603153819-0a6c8374cd9a // indirect
	github.com/cisco/go-tls-syntax v0.0.0-20200615170901-cc95af012391 // indirect
